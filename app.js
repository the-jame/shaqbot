...
//      break;
	...
	"God is an alcoholic", "Dr. Shigeru Chino wills it to be so.", "Dick Cheney profited off the Iraq war", "my opinions only get worse", "it's 'jif' not 'gif'", ":clown:", "you're going to lose subscriber", "malarkey", "da pipo, dey suffer",
	"white pipo", "it's SO BEEFY!!", "millenials killed hooters", "young metro don't trust you :sob:", "I'm in love with the coco :weary:", "you didn't hit that MF LIKE AND SUBSCRIBE BUTTON", "poopie is funny", "UH OH, stinky", "you refuse to use plex", "i am a figment of your imagination",
	"i am once again asking you to shut the fuck up", "I'm ignoring your pings", "SUKA BLYAT", "TABLE", "I hardly know her!", "i can't read", "i've shidded", "i've a smol pebis", "i'm cooming", wtf, cummies, "god has abandoned us",
