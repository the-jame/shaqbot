...
var things = ['poop', 'in n out double double', 'french fries', 'a coffee', 'hand lotion', 'nothing', 'alcohol', 
	      ...
	      'a rock', 'a boulder', 'bees', 'hot sauce', 'scotch tape', 'a breathmint', 'a facemask', 'a half eaten bar of chapstick', 'some scrap metal', 'a used condom', 
              ...
              'tupperware full of moldy leftovers', 'a white flag', 'fake news', 'the failed coup attempt perpetrated by fascist Trump supporters on the United States capitol on Jan 6, 2021',
	      ...
	      'a shit you definitely should have wiped', 'a shit you wish you didn\'t wipe', 'a protein bar that is well past the expiration date', 'a pair of shit-stained underwear',
              'an asshole', 'a really nice business card', 'an electric fly swatter', 'a stress ball that oozes blood', 'a molotov cocktail', 'an AK-47', 'a dirty old shoe', 'a hairball from the shower drain', 'bad noodle',
              'a single atom', 'a puddle of cooking oil', 'a piss disc mid-air', 'a t-shirt cannon', 'a volleyball with a face', 'in n out fries', 'cheam creems', 'spinch', 'ranibow sprimkle', 'chichen nuggest',
	      'mcdonald\'s sprite', 'chick fil a sauce', 'poopy doopy wee wee haha', 'a jar of honey', 'a comfortable sweater', 'an ugly, scratchy sweater', 'a water balloon full of vinegar',
	      'a can of pringles but they are all broken', 'a dead pig', 'dirty stripper shoes', 'super glue', 'a pen that ran dry ages ago', 'an spicey meatbole', 'a laptop with sticky keys',
	      'underwear lint','a sundress','a funko pop of your least favorite anime character', 'a security camera', 'hawaiian green bean pizza', 'my hairy ass', 'a taint hair','beast sandwich',
	      'my left nut', 'shmedium', 'cheesy garlic bread', 'ten gigs worth of women\'s butts', 'a lime scooter', 'a bullet casing', 'pork juice', 'crust', 'a nice pen'];
...
var locations = ['the Grand Canyon', 'a sex dungeon',  'my sex dungeon', 'the moon', 'the Epstein island', 'a gulag', 'Big Ben', 'Ireland', 'the bottom of the Atlantic Ocean', 'Ohio', 'Deep Stone Crypt', 'a Garfield comic',
	...
	'the cum sock', 'Lavender Town', 'Yharnam', 'Blood Gulch', 'Brazil', 'the alley behind Tesco', 'Gondor','the New California Republic', 'the New California Republic', 'Kekistan', 'Shangri-La', 'Wakanda', 'Duckburg', 'Mos Eisley', 'Castle Rock',
...
var reasons = ['said the earth is flat', 'has a girthy balloon shlong', 'h', 'stinky', 'said chemtrails are turning people gay',
	...
	'confused ham for string beans', 'was made deaf by space', 'ate bad noodle', 'thinks green beans belong on pizza',
	'sniffs cocks', 'pood and pidded', 'came in the shower', 'farted at work', 'hates minorities','is too beautiful for this earth','is a binch','sucks',
	'tried to fart but accidentally shit','once slapped a nun','is a ghost','prefers boned wings','is a degenerate','is wanted by INTERPOL','shits standing up',
	'is an undercover FBI agent', 'doesnt wipe', 'hides snacks in their foreskin', 'has ashy skin', 'has no teeth', 'invented green bean pizza', 'draws furries for a living',
	'yiffs in their free time', 'is secretly a chud', 'loves the pungent copypasta','types with two fingers', 'goes to sink-pissers anonymous', 'is addicted to crack',
	'is addicted to their own farts', 'is a nice person, actually', 'eats with their mouth open', 'microwaves cat food in the office', 'thinks the earth is flat',
	'is an antivaxxer', 'is in a coma. wake up please!', 'is illegal', 'only wipes if people are watching', 'is the reason there is always piss on the toilet seat',
	'clogged the toilet', 'is the zodiac killer', 'wishes they could feel pain', 'has diarrhea', 'is gassy', 'is a bigg dummy', 'has a sex tape', 'is ben shapiro\'s wife',
	'sucks eggs', 'walks too slowly in public', 'is Q', 'crop dusted some old guy reading the paper', 'shouldn\'t have trusted that fart', 'flew to cancun',
...
case 'invent':
    ...
    case 'eldenring':
      ...
      erPhrase = erPhrase.replace("{w}", erWord); erPhrase = erPhrase.replace("{w}", erWord);
      if (c < 0.25){
        ...
        erPhrase2 = erPhrase2.replace("{w}", erWord); erPhrase2 = erPhrase2.replace("{w}", erWord);
    ...
    case 'captainamericabuthesoldandhessayingnoidontthinkiwill':
      if (Math.random() >=0.5) message.channel.send("https://tenor.com/view/no-i-dont-think-i-will-captain-america-old-capt-gif-17162888");
    ...
    case 'islamic':
    case 'islam':
      if(Math.random() >= 0.5) message.channel.send ({files: ["img/islamic.jpg"]});
    ...
    case 'beaners':
      ...
      message.channel.send ({files: ["img/SPOILER_beaners.png"]}); break;} else {let roleRacist = message.member.roles.highest; roleRacist.setName('THE RACIST'); message.channel.send('RACIST DETECTED.');}
      break;
    case 'butdidiask':
    case 'didiask':
    case 'crazybro':
    ...
    case 'code':
      ...
      break;
    case 'paywall':
      message.channel.send ("https://discord.com/channels/95702402253983744/1099822225923788880/1237085549148246036");
      break;
    case 'drugs':
